...
export const MessageBar = () => {
  ...
  const { selectedChatType, selectedChatData, setIsUploading, setFileUploadProgress } = useContactStore();
  ...
  return (
    <div className="h-[10vh] bg-[#1c1d25] flex justify-center items-center px-8 mb-6 gap-6">
      ...
      <button
        className="transition-all duration-300 bg-[#8417ff] rounded-md flex items-center justify-center p-5 focus:border-none hover:bg-[#741bda] focus:bg-[#741bda] focus:outline-none focus:text-white"
